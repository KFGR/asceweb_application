      ...
      <Navbar className='navbar navbar-expand-lg' expand='lg'>
        <Navbar.Toggle aria-controls='basic-navbar' style={{color:'#fbb71a', backgroundColor:'#144a9a'}}/>
          <Navbar.Collapse  id='basic-navbar' style={{color:'#fbb71a'}}>
            ...
            <Nav.Link as={Link} to="/Home" className='nav-link py-1' aria-current="page" ><li style={{color:color, fontSize:'2rem'}}>Home</li></Nav.Link>
            <Nav.Link as={Link} to="/Team" className='nav-link py-1' aria-current="page" ><li style={{color:color, fontSize:'2rem'}}>Team</li></Nav.Link>
            <Nav.Link as={Link} to="/Competitions" className='nav-link py-1' aria-current="page" ><li style={{color:color, fontSize:'2rem'}}>Competitions</li></Nav.Link>
            <Nav.Link as={Link} to="/Contacts" className='nav-link py-1' aria-current="page" ><li style={{color:color, fontSize:'2rem'}}>Contacts</li></Nav.Link>
            <Nav.Link as={Link} to="/Join" className='nav-link py-1' aria-current="page" ><li style={{color:color, fontSize:'2rem'}}>Join</li></Nav.Link>
