  ...
  return (
    <div className = "AboutUs">
        ...
        <div className="auContentContainer">
          ...
          <ul className="auContentTextFont2">
            <li>Advancing civil engineering technology,</li>
            <li>Providing the tools for lifelong learning and career growth,</li>
            <li>Developing and supporting civil engineering leaders, and</li>
            <li>Advocating for the suppervision of both the infrastructure and the enviroment.</li>
          </ul>
          <p className="auContentTextFont2">
